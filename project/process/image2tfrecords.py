...
def createTfRecords(img_dir,filename,img_list):
    ...
    for image in images:
        ...
        #print(real_image)
        #将图像转换成256*256
        re_image,re_label=process_img.resize_image(img,label)
        #print(re_image.size)
...
createTfRecords('E:\数据集\MPII\mpii_human_pose_v1\images','test.tfrecords','../train1.txt')
